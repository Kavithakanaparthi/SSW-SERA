...
function getIdentityPair(kind: ContractKind, value: unknown): { holderDid?: unknown; seraDid?: unknown } {
  ...
  if (kind === "voice-confidence-envelope" || kind === "monitoring-grant" || kind === "proactive-signal" || kind === "proactive-assessment" || kind === "route-request" || kind === "route-decision" || kind === "holder-identity-context") return {holderDid:v.holder_did,seraDid:v.sera_agent_did};
